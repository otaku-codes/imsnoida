package com.himanshu.myimsguide.bba.semester2;
...
public class BbaSemster2Subjects extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bba_sem2_subjects,container,false);
