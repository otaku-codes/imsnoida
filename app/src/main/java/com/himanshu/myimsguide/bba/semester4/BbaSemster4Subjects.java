package com.himanshu.myimsguide.bba.semester4;
...
public class BbaSemster4Subjects extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bba_sem4_subjects,container,false);
