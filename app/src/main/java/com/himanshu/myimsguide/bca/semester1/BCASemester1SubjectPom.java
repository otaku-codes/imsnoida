...
public class BCASemester1SubjectPom extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bca_sem1_pom_option,container,false);

        Button button59 = view.findViewById(R.id.buttonBcaSem1PrevPaperspom);

        button59.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { listener51.onBCASem1PapersPomSelected();
            }
        });

        Button button60 = view.findViewById(R.id.buttonBcaSem1Notespom);

        button60.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //listener51.onBCASem1NotesPomSelected();
                Toast.makeText(getContext(), "Coming Soon...", Toast.LENGTH_SHORT).show();
            }
        });


        Button button6664 = view.findViewById(R.id.buttonBcaSem1QuestionBankpom);
        ...
        Button button6665 = view.findViewById(R.id.buttonBcaSem1ModelPaperspom);
