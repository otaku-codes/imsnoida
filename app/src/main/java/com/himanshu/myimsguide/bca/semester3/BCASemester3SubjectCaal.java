...
public class BCASemester3SubjectCaal extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bca_sem3_caal_option,container,false);

        Button button73 = view.findViewById(R.id.buttonBcaSem1PrevPapersCaal);
        button73.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { listener54.onBCASem3PapersCaalSelected();
            }
        });

        Button button74 = view.findViewById(R.id.buttonBcaSem1NotesCaal);
        button74.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                listener54.onBCASem3NotesCaalSelected();
                Toast.makeText(getContext(), "Coming Soon...", Toast.LENGTH_SHORT).show();
            }
        });


        Button button6665 = view.findViewById(R.id.buttonBcaSem1QuestionBankCaal);
...
//                startActivity(intent);
        ...
        Button button6666 = view.findViewById(R.id.buttonBcaSem1ModelPapersCaal);
...
//                startActivity(intent);
        ...
        Button button6667 = view.findViewById(R.id.buttonBcaSem1PrevPapersLCaal);
