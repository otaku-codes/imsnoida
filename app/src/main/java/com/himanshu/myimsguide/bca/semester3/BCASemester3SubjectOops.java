...
public class BCASemester3SubjectOops extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bca_sem3_oops_option,container,false);

        Button button71 = view.findViewById(R.id.buttonBcaSem1PrevPapersoops);
        button71.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { listener54.onBCASem3PapersOopsSelected();
            }
        });

        Button button72 = view.findViewById(R.id.buttonBcaSem1Notesoops);
        button72.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                listener54.onBCASem3NotesOopsSelected();
                Toast.makeText(getContext(), "Coming Soon...", Toast.LENGTH_SHORT).show();
            }
        });

        Button button6665 = view.findViewById(R.id.buttonBcaSem1QuestionBankuc);
...
//                startActivity(intent);
        ...
        Button button6666 = view.findViewById(R.id.buttonBcaSem1ModelPapersoc);
