...
public class BCASemester3SubjectDs extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bca_sem3_ds_option,container,false);

        Button button73 = view.findViewById(R.id.buttonBcaSem1PrevPapersDs);
        button73.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { listener54.onBCASem3PapersDsSelected();
            }
        });

        Button button74 = view.findViewById(R.id.buttonBcaSem1NotesDs);
        button74.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                listener54.onBCASem3NotesDsSelected();
                Toast.makeText(getContext(), "Coming Soon...", Toast.LENGTH_SHORT).show();
            }
        });

        Button button6665 = view.findViewById(R.id.buttonBcaSem1QuestionBankds);
...
//                startActivity(intent);
        ...
        Button button6666 = view.findViewById(R.id.buttonBcaSem1ModelPapersds);
