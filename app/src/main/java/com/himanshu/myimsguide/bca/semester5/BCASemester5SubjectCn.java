...
public class BCASemester5SubjectCn extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bca_sem5_cn_option,container,false);


        Button button97 = view.findViewById(R.id.buttonBcaSem1PrevPapersCn);
        button97.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener61.onBCASem5PapersCnSelected();
            }
        });

        Button button98 = view.findViewById(R.id.buttonBcaSem1NotesCn);
        button98.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                listener61.onBCASem5NotesCnSelected();
                Toast.makeText(getContext(), "Coming Soon....", Toast.LENGTH_SHORT).show();
            }
        });

        Button button6665 = view.findViewById(R.id.buttonBcaSem1QuestionBankcn);
...
//                startActivity(intent);
        ...
        Button button6666 = view.findViewById(R.id.buttonBcaSem1ModelPaperscn);
