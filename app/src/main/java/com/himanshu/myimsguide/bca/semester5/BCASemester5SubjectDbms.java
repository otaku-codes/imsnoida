...
public class BCASemester5SubjectDbms extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bca_sem5_dbms_option,container,false);


        Button button95 = view.findViewById(R.id.buttonBcaSem1PrevPapersDbms);
        button95.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { listener61.onBCASem5PapersDbmsSelected();
            }
        });

        Button button96 = view.findViewById(R.id.buttonBcaSem1Notesdbms);
        button96.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                listener61.onBCASem5NotesDbmsSelected();
                Toast.makeText(getContext(), "Coming Soon....", Toast.LENGTH_SHORT).show();
            }
        });

        Button button6665 = view.findViewById(R.id.buttonBcaSem1QuestionBankdbms);
...
//                startActivity(intent);
        ...
        Button button6666 = view.findViewById(R.id.buttonBcaSem1ModelPapersdbms);
