...
public class BCASemester3SubjectFam extends Fragment {

    private MainFragment.onFragmentBtnSelected listener54;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_bca_sem3_fam_option,container,false);

        Button button75 = view.findViewById(R.id.buttonBcaSem1PrevPapersFam);
        button75.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { listener54.onBCASem3PapersFamSelected();
            }
        });

        Button button76 = view.findViewById(R.id.buttonBcaSem1NotesEs);
        button76.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                listener54.onBCASem3NotesFamSelected();
                Toast.makeText(getContext(), "Coming Soon...", Toast.LENGTH_SHORT).show();
            }
        });

        Button button6665 = view.findViewById(R.id.buttonBcaSem1QuestionBankes);
...
//                startActivity(intent);
        ...
        Button button6666 = view.findViewById(R.id.buttonBcaSem1ModelPaperses);
